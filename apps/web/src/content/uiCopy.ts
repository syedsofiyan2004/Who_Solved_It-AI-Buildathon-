export const copy = {
  ...
  search: {
    ...
    keywordAvailable: "Keyword and exact-error search is active.",
    summaryAvailable: "Grounded summaries are available for reliable matches.",
