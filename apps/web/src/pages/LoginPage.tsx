      ...
      <section className="relative mx-auto grid min-h-[calc(100vh-2.5rem)] w-full max-w-[1240px] overflow-hidden rounded-[18px] border border-border bg-surface/95 shadow-overlay lg:grid-cols-[minmax(0,1.25fr)_440px]">
        ...
        <div className="flex items-center p-6 sm:p-10">
          <form className="w-full" onSubmit={handleSubmit(onSubmit)} noValidate>
            ...
            <div className="my-7 flex items-center gap-3"><span className="h-px flex-1 bg-border" /><span className="font-data text-[10px] uppercase tracking-[0.14em] text-text-muted">{copy.login.seededAccess}</span><span className="h-px flex-1 bg-border" /></div>
    ...
    <div className="relative overflow-hidden rounded-[12px] border border-border bg-elevated/95 p-4 shadow-soft sm:p-5">
      ...
      <div className="mt-4 grid gap-3 sm:grid-cols-[minmax(0,1fr)_180px]">
        ...
        <div className="rounded-[10px] border border-border bg-surface p-4">
          <span className="grid h-9 w-9 place-items-center rounded-full bg-brand-soft font-data text-xs font-semibold text-brand-strong">SS</span>
